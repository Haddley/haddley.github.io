...
I wanted to train my model for this using StarCoder2. StarCode2 already exists, was trained on far more code than I could gather, and is small enough to run on this machine. What I do need is raw training examples: real HTML documents, not code embedded in Q&A pairs or Stack Overflow snippets.
