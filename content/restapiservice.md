...
I used npm to initialise a REST API project.
...
I updated the package.json file generated by npm:


## The index.js file

I updated the index.js file generated by npm:


## The Dockerfile

I used Visual Studio Code to add a Dockerfile to the project. I opened the Command Palette (⇧⌘P) and used the "Docker: Add Docker Files to Workspace..." command:
